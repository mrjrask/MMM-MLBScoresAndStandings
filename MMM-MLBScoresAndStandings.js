...
// Only register in browser context where Module is defined
if (typeof Module !== "undefined" && Module.register) {
  Module.register("MMM-MLBScoresAndStandings", {
    ...
    createGameBox(game) {
      ...
      // Title row: abbr + logos and time right-aligned
      ...
      ["", "R", "H", "E"].forEach(lbl => {
        const th = document.createElement("th"); th.innerText = lbl; hdr.appendChild(th);
      });
