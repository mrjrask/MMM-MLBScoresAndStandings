...
Module.register("MMM-MLBScoresAndStandings", {
  ...
  _buildStandings() {
    ...
    [pair.nl, pair.al].forEach(id => {
      const grp = this.recordGroups.find(r => r.division.id === id);
      if (grp) {
