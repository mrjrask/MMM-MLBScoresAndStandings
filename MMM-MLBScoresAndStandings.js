...
if (typeof Module !== "undefined" && Module.register) {
  Module.register("MMM-MLBScoresAndStandings", {
    ...
    start() {
      ...
      this.totalStandingsPages = 0; // will recalc on data
    ...
    getDom() {
      ...
      if (inGames) {
        ...
        // pair two divisions together
        const idx = this.currentScreen - this.totalGamePages;
        const first  = this.recordGroups[idx * 1];
    ...
    createGameBox(game) { /* unchanged */ },
    createStandingsTable(group) { /* unchanged */ },
    getLogoUrl(abbr) {
